...
# inputs:
#
#       Apars   - parameters for surface albedo model, A0 = slope, A1 = intercept
#         lam   - wavelength array (um)
#

def linear_fit(lam,m,b): #for use in agnostic retrievals in surfalb below, m is slope, b is intercept
	return m*(lam-0.2) + b
...
def surfalb(Apars,lam): 
  ...
  As = linear_fit(lam, Apars[0], Apars[1])
